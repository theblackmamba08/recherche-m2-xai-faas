"""Génère code/notebooks/softcam-cluster4-v3-runB7.ipynb (Phase 2 — H1 v3 Run B7).

Run B7 : test mix=0.15 avec tous les fixes de Run B5.
...
Historique :
  ...
  Run B7 (warm-up→0.15, anneal γ, LayerNorm)       : ?

Objectif : vérifier si mix=0.15 avec warm-up donne de meilleures métriques que B5 (mix=0.05).
Seul changement vs B5 : EVIDENCE_MIX_TARGET = 0.15 (au lieu de 0.05).
Tous les autres paramètres identiques.

Lance : python _generate_softcam_cluster4_v3_runB7.py
"""

import json
from pathlib import Path

NOTEBOOK_PATH = Path(__file__).parent / "softcam-cluster4-v3-runB7.ipynb"
